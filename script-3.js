...
// =====================================================
// PHOTO GALLERIES — DATA-DRIVEN, REUSABLE FOR ANY SECTION
// Lightbox + WhatsApp CTA. One system powers every gallery
// on the site (Craft, Loafers, Sneakers, and any future ones).
//
// ---- HOW TO ADD A BRAND NEW SECTION LATER (e.g. "Sandals") ----
// 1. Copy one of the arrays below (e.g. sneakerPhotos) and
//    rename it, e.g. `const sandalPhotos = [ ... ];`
// 2. Add it to the `galleries` registry object further down:
//       sandals: sandalPhotos,
// 3. In index.html, copy the #loafers or #sneakers <section>
//    block, change the id, heading text, and the grid container
//    id (e.g. id="sandalGallery").
// 4. Add one line at the bottom of this file:
//       renderPhotoGrid('sandalGallery', 'sandals');
// That's it — lightbox, WhatsApp button, hover effects, and the
// dynamic big/tall tile pattern all work automatically.
//
// ---- HOW TO ADD MORE PHOTOS TO AN EXISTING SECTION ----
// Just add a new line to that section's array below, following
// the same format, and upload the matching image file to the
// folder mentioned in its `src`. Nothing else needs to change.
// =====================================================
...
// ---- NEW SECTION: Premium Loafer ----
// Add your loafer photo filenames here. Upload the image files
// to images/loafers/ with matching filenames.
const loaferPhotos = [
  { src: "images/loafers/loafer-01.jpg", alt: "Arutemika premium leather loafer 01", caption: "Premium Loafer — Photo 01" },
  { src: "images/loafers/loafer-02.jpg", alt: "Arutemika premium leather loafer 02", caption: "Premium Loafer — Photo 02" },
  { src: "images/loafers/loafer-03.jpg", alt: "Arutemika premium leather loafer 03", caption: "Premium Loafer — Photo 03" },
  // ↓ add more lines exactly like the ones above as you get more photos
];

// ---- NEW SECTION: Sneakers ----
// Add your sneaker photo filenames here. Upload the image files
// to images/sneakers/ with matching filenames.
const sneakerPhotos = [
  { src: "images/sneakers/sneaker-01.jpg", alt: "Arutemika leather sneaker 01", caption: "Sneakers — Photo 01" },
  { src: "images/sneakers/sneaker-02.jpg", alt: "Arutemika leather sneaker 02", caption: "Sneakers — Photo 02" },
  { src: "images/sneakers/sneaker-03.jpg", alt: "Arutemika leather sneaker 03", caption: "Sneakers — Photo 03" },
  // ↓ add more lines exactly like the ones above as you get more photos
];

// ---- Registry: every gallery on the site lives here ----
// To add a future section, just add one more line:  key: arrayName,
const galleries = {
  craft: galleryPhotos,
  loafers: loaferPhotos,
  sneakers: sneakerPhotos,
};
...
// containerId = the id of the empty <div> in index.html
// galleryKey  = the key you used in the `galleries` registry above
...
function updateLightbox() {
  ...
  document.getElementById('lightboxCounter').textContent = `${photo.caption} — ${currentPhotoIndex + 1} / ${photos.length}`;
...
// ---- Render every gallery on the page ----
// When you add a new section, add one line here too:
//   renderPhotoGrid('yourContainerId', 'yourGalleryKey');
